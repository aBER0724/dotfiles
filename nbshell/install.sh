...
for patch_file in niri-named-workspaces.patch bar-visibility.patch screensaver-fit.patch screensaver-preview.patch kitty-screensaver-fullscreen.patch tray-polish.patch popout-gap.patch; do
